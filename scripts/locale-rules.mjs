...
export const WIP_LOCALES = {
  th: 'Thai backfill in flight — batches 1-6 land on this branch and the entry is deleted in the whole-language-sweep commit (docs/i18n/backfill-runbook.md section 7).',
};
