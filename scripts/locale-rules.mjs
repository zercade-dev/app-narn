...
export const WIP_LOCALES = {
  'zh-hant':
    'Traditional Chinese backfill in flight — batches 1-6 land on one branch, and this ' +
    'entry is deleted in the whole-language sweep commit that lands the last namespace.',
};
