...
- Every bundled Google model was benchmarked per language (24 test strings judged for quality and format compliance); routing prefers measured-strong pairings.
