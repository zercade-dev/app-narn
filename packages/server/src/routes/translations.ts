...
translationsRouter.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    // is guaranteed to translate nothing. Runs BEFORE the glossary check below:
    // it is cheaper, and "you have no routing at all" is the more fundamental
    // thing to tell a user who has just set the project up.
    //
